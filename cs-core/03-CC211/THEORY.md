# Teoría del Curso: Programación Orientada a Objetos
...
- **L**iskov Substitution: Las subclases deben ser sustituibles por sus clases
  base.
- **I**nterface Segregation: Muchas interfaces específicas son mejores que una
  general.
...
- **Composición**: "Es parte de" (relación fuerte, ciclo de vida compartido).
- **Herencia**: "Es un".
