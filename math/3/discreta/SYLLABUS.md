...
Estudio de estructuras matemáticas contables o distintas. Es el lenguaje
matemático de las ciencias de la computación.
...
- Métodos de demostración (Inducción, Contradicción).
...
- Grafos, caminos, ciclos.
- Árboles.
- Algoritmos básicos (BFS, DFS, Dijkstra).
